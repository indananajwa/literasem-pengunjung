            ...
            <div class="carousel-item" x-show="currentSlide === 0" x-transition>
                ...
                <div class="text-center mt-8 max-w-2xl mx-auto">
                    ...
                    <p class="text-gray-600">
                        Lawang Sewu, yang berarti 'Seribu Pintu', adalah ikon arsitektur kolonial Belanda di Semarang. Kini, gedung ini tetap berdiri megah sebagai destinasi wisata sejarah.
                    </p>
                </div>
            </div>
